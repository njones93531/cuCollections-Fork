...
TEMPLATE_TEST_CASE_SIG(
  "static_map insert_and_find tests id",
  "",
  ...
  (int64_t, int64_t, cuco::test::probe_sequence::linear_probing, 2))
{
  using probe = std::conditional_t<
    ...
    cuco::linear_probing<CGSize, cuco::identityhash_32<Key>>,
    cuco::double_hashing<CGSize, cuco::identityhash_32<Key>, cuco::identityhash_32<Key>>>;
