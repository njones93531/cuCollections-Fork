...
auto constexpr SIZE          = 4'294'967'296;
...
auto const N_RANGE_CACHE = std::vector<nvbench::int64_t>{
  8'000, 80'000, 800'000, 8'000'000, 80'000'000, 800'000'000, 4'000'000'000};
auto const OCCUPANCY_RANGE     = nvbench::range(0.1, 1.0, 0.1);
